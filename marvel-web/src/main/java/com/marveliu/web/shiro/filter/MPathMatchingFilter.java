...
/**
 * @Author: Marveliu
 * @Date: 2018/9/29 上午11:39
 * @Description: 重写过滤链路径匹配规则，增加REST风格post,get.delete,put..支持
 * @Refer: https://segmentfault.com/a/1190000014545172
 **/

@Slf4j
public abstract class MPathMatchingFilter extends PathMatchingFilter {

    public MPathMatchingFilter() {
    }
